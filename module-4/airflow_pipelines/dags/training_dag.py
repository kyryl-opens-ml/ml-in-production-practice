...
DOCKER_IMAGE = "ghcr.io/kyryl-opens-ml/classic-example:latest"
STORAGE_NAME = "training-storage"

volume = k8s.V1Volume(name=STORAGE_NAME, persistent_volume_claim=k8s.V1PersistentVolumeClaimVolumeSource(claim_name=STORAGE_NAME))
